...
with urlopen("https://opentdb.com/api.php?amount=10&category=15&difficulty=easy&type=multiple") as webpage:
...
def clear_parameters():
    ...
    parameters["index"].append(random.randint(0,9))
...
def create_buttons(answer, l_margin, r_margin):
    ...
    button.clicked.connect(lambda x: is_corect(button))
    return button
